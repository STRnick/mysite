...
public class BoardService {
	...
	public BoardVo getContents(Long no, Long user_no) {
		BoardVo boardVo = boardRepository.findByNoAndUserNo(no, user_no);
		return boardVo;
	}
	...
	public boolean deleteContents(Long boardNo, Long user_no) {
		int count = boardRepository.delete(boardNo, user_no);
		return count == 1;
	}
	...
	public boolean increaseGroupOrderNo(BoardVo boardVo) {
		return boardRepository.updateOrderNo(boardVo.getG_no(), boardVo.getO_no()) > 0;
	}
}